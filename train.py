...
def main():
    ...
    animegan = AnimeGANv2(args)

    # build graph
    animegan.build_model()

    """
        model fundamental Test
    """
    # print model
    ...
    # print('generated size',generated_image.shape)
    # discrimintor_result = animegan.discriminator(generated_image)
    # print('discriminator size', discrimintor_result.shape)
